...
export default function PageNotFound() {
    ...
    <section className="flex flex-col justify-center items-center h-[100vh] text-c-4 max-w-[360px] mx-auto box-border p-5">
        ...
        <p className="text-md font-light text-center p-3">La platforme qui facilite votre vie et la création de vos portfolio selon vos besoins</p>

        <p className="flex flex-col items-center justify-center text-center p-6"> <span className="flex "><MdLabelImportant/> Pour les utilisateurs ou ceux pour ceux qui veulent profités de nos service,</span> <br /> <a href={`http://${window.location.hostname}:5173/`} className="bg-c-3 text-c-2 p-1 px-3 rounded-sm">cliquer ici</a> </p>
