...
export default function Template7({lien_portfolio}) {
    ...
    <img src={bg} alt=""  className="fixed -z-10 w-full blur-sm h-full"/>
        ...
        <div className="md:w-1/2">
            ...
            <div className="md:w-1/2 p-4 text-justify md:flex flex-col">
                ...
                <Dialog>
                    <DialogTrigger className="boutonTmp37 overflow-scroll">Mon Parcour scolaire</DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>
                ...
                <Dialog>
                    <DialogTrigger className="boutonTmp3sansBg">
                        Mon parcour professionnel
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Mon Parcour professionnel</DialogTitle>
                        </DialogHeader>
