...
export default function Template3({lien_portfolio}) {
    ...
    return <>
        <header className="flex gap-2 justify-between p-2 px-6 shadow-2xl">
            <p className="text-xl font-bold">{portfolio.firstname} {portfolio.lastname}</p>
            <nav>
                <Dialog>
                    <DialogTrigger className="text-base text-balance text-primary hover:border-b border-primary transition-all duration-100">Contacts</DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
        ...
        <section className="md:flex p-4 max-h-[100vh]">
            ...
            <div className="md:w-1/2">
                <img src={`http://${window.location.hostname}:1627/portfolio/photo/${portfolio.id}`} alt=""  className="w-3/4 mx-auto rounded-full"/>
            </div>
        </section>
    </>
}